...
PLAYER_QUERIES_HIGHLIGHTS = {
    "soccer": [
        "{player} soccer highlights 2025",
        "{player} football best goals 2025",
        "{player} soccer skills 2025",
        "{player} football goals compilation",
        "{player} soccer best moments 2025",
        "{player} football amazing goals",
        "{player} soccer skills compilation",
        "{player} football top plays 2025",
    ],
    "nba": [
        "{player} NBA highlights 2025",
        "{player} basketball best plays 2025",
        "{player} NBA dunks 2025",
        "{player} basketball skills 2025",
        "{player} NBA top moments 2025",
        "{player} basketball clutch plays",
        "{player} NBA scoring highlights",
        "{player} basketball highlights",
    ],
    "nfl": [
